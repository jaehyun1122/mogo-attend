...
| LOGIN_URL              | 로그인 폼 요청 URL                     | 기본으로 설정되어 있습니다. (건들 필요 없음) |
| TARGET_PAGE_URL        | 출석 대상 메인 페이지 URL              | 기본으로 설정되어 있습니다. (건들 필요 없음) |
| ATTENDANCE_URL         | 실제 출석 처리 POST URL                | 기본으로 설정되어 있습니다. (건들 필요 없음) |
| SITE_URL               | 출석 페이지(캡차 sitekey 추출용)       | 기본으로 설정되어 있습니다. (건들 필요 없음) |
| CAPTCHA_SERVICE_URL    | 2Captcha API 기본값                    | 기본으로 설정되어 있습니다. (건들 필요 없음) |
